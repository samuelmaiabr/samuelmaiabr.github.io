...
Para garantir a **repetibilidade** (ou **reprodutibilidade computacional**)[^verrepetibilidade] disponibilizo dois arquivos-chave em **R**: 
...
## **Informações do Ambiente, Pacotes e Reprodutibilidade**
```{r, echo=FALSE, results="asis"}
# Exibir informações do ambiente
cat("## 1. Informações do Ambiente\n")
cat("```r\n")
cat(readLines("report_data/session_infos_cleaning.txt"), sep="\n")
cat("\n```\n\n")

# Exibir pacotes usados no script (grateful)
cat("## 2. Pacotes Usados no Script (`grateful`)\n")
cat(readLines("report_data/grateful-reports_cleaning.html"), sep="\n")
cat("\n\n")

# Exibir lista de pacotes instalados
library(knitr)
installed_packages <- read.csv("report_data/installed_packagess_cleaning.csv")
cat("## 3. Lista de Todos os Pacotes Instalados\n")
kable(installed_packages, caption = "Lista de Pacotes Instalados")

# Exibir status do `renv`, se aplicável
if (file.exists("report_data/renv_status_cleaning.txt")) {
  cat("\n\n## 4. Status do `renv` (se aplicável)\n")
  cat("```r\n")
  cat(readLines("report_data/renv_status_cleaning.txt"), sep="\n")
  cat("\n```\n\n")
}
```
