...
O objetivo principal deste apêndice é permitir a **replicabilidade computacional** pela:

- recriação o ambiente de trabalho usado na análise do ***Projeto***;
- identificação das versões específicas de pacotes utilizados;
- compreensão  das dependências do sistema e
- validação da integridade do ambiente através do `renv`.
...
5. Metadados críticos para repetibilidade ou replicação computacional
