...
install.packages(c("webshot2", "rmarkdown", "pagedown"))

library(webshot2)   # For screenshot of HTML
library(rmarkdown)  # For rendering the markdown file
library(pagedown)   # Converts HTML to an image

# 1. Define the Markdown Table
table_db_md <- "
